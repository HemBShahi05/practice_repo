...
SET DATA TYPE date USING to_date(hire_date, 'MM/DD/YYYY')
ALTER COLUMN birth_date 
SET DATA TYPE date USING to_date(birth_date, 'MM/DD/YYYY');
...
SELECT e.emp_no, e.last_name, e.first_name, de.dept_name,  d.dept_no 
FROM employees e
